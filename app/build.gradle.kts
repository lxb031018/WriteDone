...
android {
    ...
    signingConfigs {
        create("release") {
            ...
            storePassword = env["WRITEDONE_STORE_PASSWORD"] ?: return@create
            keyAlias = env["WRITEDONE_KEY_ALIAS"] ?: return@create
            keyPassword = env["WRITEDONE_KEY_PASSWORD"] ?: return@create
        }
    }
